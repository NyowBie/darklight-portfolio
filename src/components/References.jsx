        ...
        <section>
            ...
            <div className="space-y-4">
                <div className="p-4 bg-white/5 border border-white/5 rounded-xl hover:border-cyan-500/30 transition-colors">
                    ...
                    <p className="text-xs text-slate-500 font-mono">09750324047</p>
                </div>

                <div className="p-4 bg-white/5 border border-white/5 rounded-xl hover:border-cyan-500/30 transition-colors">
                    <h3 className="text-sm font-bold text-white">Katrina Shaine D. Suñiga</h3>
                    <p className="text-xs text-cyan-400 font-medium mb-1">Accounting Clerk, Golden Advance</p>
                    <p className="text-xs text-slate-500 font-mono">09618553048</p>
                </div>
            </div>
        </section>
    );
